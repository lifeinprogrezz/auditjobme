      ...
      <div className="ui">
        ...
        <div className="madeby" aria-label="Site creator">
          ...
          {/* Northgoing is open source (MIT) — the repo sits with the creator links so a
              ...
              The GitHub slug stays `auditjobme`: the repo was NOT renamed, so a
              `northgoing` slug would 404 for everyone who clicks this. */}
          <a className="mb-ico" href="https://github.com/lifeinprogrezz/auditjobme" target="_blank" rel="noopener noreferrer" aria-label={`${BRAND_NAME} source code on GitHub`}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
