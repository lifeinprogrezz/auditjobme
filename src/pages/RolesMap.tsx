    ...
    <div className={rootClass}>
      ...
      <div className="ui">
        ...
        <div className="madeby" aria-label="Site creator">
          ...
          {/* auditjob.me is open source (MIT) — the repo sits with the creator links so a
              curious visitor finds it on the map, the only surface anons ever see. */}
          <a className="mb-ico" href="https://github.com/lifeinprogrezz/auditjobme" target="_blank" rel="noopener noreferrer" aria-label="auditjob.me source code on GitHub">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
