---
description: Build, test, and smoke-walk the canonical user path of the Northgoing web app
allowed-tools: Bash
---
Verify the Northgoing web app actually works, not just that it compiles. Run these steps in order from the repo root; stop and report at the first hard failure.
