...
allowed-tools: Bash
---
Verify the auditjob.me web app actually works, not just that it compiles. Run these steps in order from the repo root; stop and report at the first hard failure.
